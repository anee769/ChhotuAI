...
`tonne`, `kg`, `piece`, `box` aur grounded English order status. Quantity aur
amount Arabic digits mein, aur date `YYYY-MM-DD` mein bhejo.
...
PARAM_DOCS = {
    ...
    "items": ("Text", "Ek hi sale, purchase, bill ya order ki saari lines ka "
              "JSON array. Har line "
              "mein item ya exact sku_id, qty, unit, rate aur optional "
              "rate_unit. Caller ke saare bole hue items isi ek array mein "
              "bhejo; sirf pehla item mat bhejo. Single item ho to flat "
              "fields bhi chalenge."),
}
